<div {{ $attributes->merge(['class' => 'pajak-email-footer']) }} style="background: #F7F9FF; border-top: 1px solid #EEF2FB; border-radius: 0 0 14px 14px; padding: 24px 40px; text-align: center;">
    @isset($logo)
