...
final class DropzoneTest extends TestCase
{
    ...
    {
        $dropzone = new Dropzone(name: 'documents');
    ...
    {
        $dropzone = new Dropzone(name: 'documents', id: 'my-dropzone');
    ...
    {
        $dropzone = new Dropzone(name: 'documents', error: 'File is required');
    ...
    {
        $dropzone = new Dropzone(name: 'documents', state: State::Success);
    ...
    public function testFilesArrayIsStoredFromArray(): void
    {
        ...
        $dropzone = new Dropzone(name: 'documents', files: [$file]);
    ...
    {
        $file = new UploadedFile(1, 'document.pdf', 1024, '/uploads/document.pdf');
        $dropzone = new Dropzone(name: 'documents', files: new ArrayIterator([$file]));
