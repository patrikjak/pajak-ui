...
final class AvatarTest extends TestCase
{
    ...
    {
        $avatar = new Avatar('profile_photo');
    ...
    {
        $avatar = new Avatar('profile_photo', null, null, null, State::Default, false, 'my-avatar');
    ...
    {
        $avatar = new Avatar('profile_photo', null, null, null, State::Default, false, null, 'Photo is required');
    ...
    {
        $avatar = new Avatar('profile_photo', null, null, null, State::Success);
    ...
    {
        $avatar = new Avatar('profile_photo', null, '/uploads/avatar.jpg');
